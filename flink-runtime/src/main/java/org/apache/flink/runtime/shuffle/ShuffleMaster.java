 ...
 *     exchange.
 */
// 实现了对InputGate 和ResultPartition的注册

//  ShuffleManager 实例化时机
// => Dispather实例化
// => JobManagerSharedServices.fromConfiguration方法
// => ShuffleServiceLoader.loadShuffleServiceFactory(config) 动态加载
