package org.apache.flink.spring;
...
@Configuration
@ComponentScan({ "org.apache.flink" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "org.apache.flink");
                servletContext.setInitParameter("tapestry.development-modules", "org.apache.flink.services.DevelopmentModule");
