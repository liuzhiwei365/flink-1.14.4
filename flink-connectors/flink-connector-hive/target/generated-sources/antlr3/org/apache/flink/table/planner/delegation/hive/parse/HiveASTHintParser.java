...
public class HiveASTHintParser extends Parser {
	...
	public static final int TOK_HINT=356;
	public static final int TOK_HINTARGLIST=357;
	public static final int TOK_HINTLIST=358;
	public static final int TOK_MAPJOIN=359;
	public static final int TOK_STREAMTABLE=360;
	...
	public HiveASTHintParser(TokenStream input) {
		this(input, new RecognizerSharedState());
	}
	public HiveASTHintParser(TokenStream input, RecognizerSharedState state) {
		super(input, state);
	}
	...
	@Override public String[] getTokenNames() { return HiveASTHintParser.tokenNames; }
	@Override public String getGrammarFileName() { return "org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g"; }
	...
	// $ANTLR start "hint"
	// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:59:1: hint : hintList EOF -> ^( TOK_HINTLIST hintList ) ;
	public final HiveASTHintParser.hint_return hint() throws RecognitionException {
		HiveASTHintParser.hint_return retval = new HiveASTHintParser.hint_return();
		...
		try {
			// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:60:5: ( hintList EOF -> ^( TOK_HINTLIST hintList ) )
			// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:60:7: hintList EOF
			{
			pushFollow(FOLLOW_hintList_in_hint105);
			hintList1=hintList();
			state._fsp--;

			stream_hintList.add(hintList1.getTree());
			EOF2=(Token)match(input,EOF,FOLLOW_EOF_in_hint107);  
			stream_EOF.add(EOF2);
			...
			// 60:20: -> ^( TOK_HINTLIST hintList )
			{
				// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:60:23: ^( TOK_HINTLIST hintList )
				{
				HiveParserASTNode root_1 = (HiveParserASTNode)adaptor.nil();
				root_1 = (HiveParserASTNode)adaptor.becomeRoot((HiveParserASTNode)adaptor.create(TOK_HINTLIST, "TOK_HINTLIST"), root_1);
			...
			reportError(re);
			recover(input,re);
			retval.tree = (HiveParserASTNode)adaptor.errorNode(input, retval.start, input.LT(-1), re);
		}
		finally {
	...
	// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:63:1: hintList : hintItem ( COMMA hintItem )* -> ( hintItem )+ ;
	public final HiveASTHintParser.hintList_return hintList() throws RecognitionException {
		HiveASTHintParser.hintList_return retval = new HiveASTHintParser.hintList_return();
		retval.start = input.LT(1);
		...
		HiveParserASTNode COMMA4_tree=null;
		RewriteRuleTokenStream stream_COMMA=new RewriteRuleTokenStream(adaptor,"token COMMA");
		RewriteRuleSubtreeStream stream_hintItem=new RewriteRuleSubtreeStream(adaptor,"rule hintItem");

		try {
			// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:64:5: ( hintItem ( COMMA hintItem )* -> ( hintItem )+ )
			// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:65:5: hintItem ( COMMA hintItem )*
			{
			pushFollow(FOLLOW_hintItem_in_hintList136);
			hintItem3=hintItem();
			state._fsp--;

			stream_hintItem.add(hintItem3.getTree());
			// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:65:14: ( COMMA hintItem )*
			loop1:
			while (true) {
				int alt1=2;
				...
				switch (alt1) {
				case 1 :
					// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:65:15: COMMA hintItem
					{
					COMMA4=(Token)match(input,COMMA,FOLLOW_COMMA_in_hintList139);  
					stream_COMMA.add(COMMA4);

					pushFollow(FOLLOW_hintItem_in_hintList141);
					hintItem5=hintItem();
					state._fsp--;
	...
	// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:68:1: hintItem : hintName ( LPAREN hintArgs RPAREN )? -> ^( TOK_HINT hintName ( hintArgs )? ) ;
	public final HiveASTHintParser.hintItem_return hintItem() throws RecognitionException {
		HiveASTHintParser.hintItem_return retval = new HiveASTHintParser.hintItem_return();
		retval.start = input.LT(1);
		...
		HiveParserASTNode LPAREN7_tree=null;
		HiveParserASTNode RPAREN9_tree=null;
		...
		try {
			// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:69:5: ( hintName ( LPAREN hintArgs RPAREN )? -> ^( TOK_HINT hintName ( hintArgs )? ) )
			// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:70:5: hintName ( LPAREN hintArgs RPAREN )?
			{
			pushFollow(FOLLOW_hintName_in_hintItem169);
			hintName6=hintName();
			state._fsp--;

			stream_hintName.add(hintName6.getTree());
			// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:70:14: ( LPAREN hintArgs RPAREN )?
			int alt2=2;
			...
			switch (alt2) {
				case 1 :
					// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:70:15: LPAREN hintArgs RPAREN
					{
					LPAREN7=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_hintItem172);  
					stream_LPAREN.add(LPAREN7);

					pushFollow(FOLLOW_hintArgs_in_hintItem174);
					hintArgs8=hintArgs();
					state._fsp--;

					stream_hintArgs.add(hintArgs8.getTree());
					RPAREN9=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_hintItem176);  
			...
			root_0 = (HiveParserASTNode)adaptor.nil();
			// 70:40: -> ^( TOK_HINT hintName ( hintArgs )? )
			{
				// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:70:43: ^( TOK_HINT hintName ( hintArgs )? )
				{
				HiveParserASTNode root_1 = (HiveParserASTNode)adaptor.nil();
				root_1 = (HiveParserASTNode)adaptor.becomeRoot((HiveParserASTNode)adaptor.create(TOK_HINT, "TOK_HINT"), root_1);
				adaptor.addChild(root_1, stream_hintName.nextTree());
				// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:70:63: ( hintArgs )?
	...
	// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:73:1: hintName : ( KW_MAPJOIN -> TOK_MAPJOIN | KW_STREAMTABLE -> TOK_STREAMTABLE );
	public final HiveASTHintParser.hintName_return hintName() throws RecognitionException {
		HiveASTHintParser.hintName_return retval = new HiveASTHintParser.hintName_return();
		retval.start = input.LT(1);
		...
		HiveParserASTNode KW_MAPJOIN10_tree=null;
		HiveParserASTNode KW_STREAMTABLE11_tree=null;
		...
		try {
			// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:74:5: ( KW_MAPJOIN -> TOK_MAPJOIN | KW_STREAMTABLE -> TOK_STREAMTABLE )
			int alt3=2;
			...
			switch (alt3) {
				case 1 :
					// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:75:5: KW_MAPJOIN
					{
					KW_MAPJOIN10=(Token)match(input,KW_MAPJOIN,FOLLOW_KW_MAPJOIN_in_hintName210);  
					...
					// 75:16: -> TOK_MAPJOIN
					{
						adaptor.addChild(root_0, (HiveParserASTNode)adaptor.create(TOK_MAPJOIN, "TOK_MAPJOIN"));
					}
					...
					break;
				case 2 :
					// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:76:7: KW_STREAMTABLE
					{
					KW_STREAMTABLE11=(Token)match(input,KW_STREAMTABLE,FOLLOW_KW_STREAMTABLE_in_hintName222);  
					...
					{
						adaptor.addChild(root_0, (HiveParserASTNode)adaptor.create(TOK_STREAMTABLE, "TOK_STREAMTABLE"));
					}
	...
	// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:79:1: hintArgs : hintArgName ( COMMA hintArgName )* -> ^( TOK_HINTARGLIST ( hintArgName )+ ) ;
	public final HiveASTHintParser.hintArgs_return hintArgs() throws RecognitionException {
		HiveASTHintParser.hintArgs_return retval = new HiveASTHintParser.hintArgs_return();
		retval.start = input.LT(1);
		...
		HiveParserASTNode COMMA13_tree=null;
		RewriteRuleTokenStream stream_COMMA=new RewriteRuleTokenStream(adaptor,"token COMMA");
		RewriteRuleSubtreeStream stream_hintArgName=new RewriteRuleSubtreeStream(adaptor,"rule hintArgName");

		try {
			// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:80:5: ( hintArgName ( COMMA hintArgName )* -> ^( TOK_HINTARGLIST ( hintArgName )+ ) )
			// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:81:5: hintArgName ( COMMA hintArgName )*
			{
			pushFollow(FOLLOW_hintArgName_in_hintArgs247);
			hintArgName12=hintArgName();
			state._fsp--;

			stream_hintArgName.add(hintArgName12.getTree());
			// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:81:17: ( COMMA hintArgName )*
			loop4:
			while (true) {
				int alt4=2;
				...
				switch (alt4) {
				case 1 :
					// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:81:18: COMMA hintArgName
					{
					COMMA13=(Token)match(input,COMMA,FOLLOW_COMMA_in_hintArgs250);  
					stream_COMMA.add(COMMA13);

					pushFollow(FOLLOW_hintArgName_in_hintArgs252);
			...
			root_0 = (HiveParserASTNode)adaptor.nil();
			// 81:38: -> ^( TOK_HINTARGLIST ( hintArgName )+ )
			{
				// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:81:41: ^( TOK_HINTARGLIST ( hintArgName )+ )
				{
				HiveParserASTNode root_1 = (HiveParserASTNode)adaptor.nil();
				root_1 = (HiveParserASTNode)adaptor.becomeRoot((HiveParserASTNode)adaptor.create(TOK_HINTARGLIST, "TOK_HINTARGLIST"), root_1);
	...
	// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:84:1: hintArgName : Identifier ;
	public final HiveASTHintParser.hintArgName_return hintArgName() throws RecognitionException {
		HiveASTHintParser.hintArgName_return retval = new HiveASTHintParser.hintArgName_return();
		retval.start = input.LT(1);
		...
		HiveParserASTNode Identifier15_tree=null;

		try {
			// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:85:5: ( Identifier )
			// org/apache/flink/table/planner/delegation/hive/parse/HiveASTHintParser.g:86:5: Identifier
			{
			root_0 = (HiveParserASTNode)adaptor.nil();


			Identifier15=(Token)match(input,Identifier,FOLLOW_Identifier_in_hintArgName284); 
			Identifier15_tree = (HiveParserASTNode)adaptor.create(Identifier15);
	...
	public static final BitSet FOLLOW_hintList_in_hint105 = new BitSet(new long[]{0x0000000000000000L});
	public static final BitSet FOLLOW_EOF_in_hint107 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_hintItem_in_hintList136 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_COMMA_in_hintList139 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0008000000000000L,0x0000000000000000L,0x0000000000100000L});
	public static final BitSet FOLLOW_hintItem_in_hintList141 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_hintName_in_hintItem169 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000008000L});
	public static final BitSet FOLLOW_LPAREN_in_hintItem172 = new BitSet(new long[]{0x0000000001000000L});
	public static final BitSet FOLLOW_hintArgs_in_hintItem174 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000010000000L});
	public static final BitSet FOLLOW_RPAREN_in_hintItem176 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_KW_MAPJOIN_in_hintName210 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_KW_STREAMTABLE_in_hintName222 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_hintArgName_in_hintArgs247 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_COMMA_in_hintArgs250 = new BitSet(new long[]{0x0000000001000000L});
	public static final BitSet FOLLOW_hintArgName_in_hintArgs252 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_Identifier_in_hintArgName284 = new BitSet(new long[]{0x0000000000000002L});
}
